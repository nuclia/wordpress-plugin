...
<section class="progress-agentic-rag__panel" aria-labelledby="progress-agentic-rag-connection-title">
	<div class="progress-agentic-rag__panel-header">
		<div>
			<div class="progress-agentic-rag__section-label"><?php esc_html_e( 'Service access', 'progress-agentic-rag-connector' ); ?></div>
			<h2 id="progress-agentic-rag-connection-title"><?php esc_html_e( 'Connection settings', 'progress-agentic-rag-connector' ); ?></h2>
		</div>
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
		...
		<div class="progress-agentic-rag__field-grid">
			<label class="progress-agentic-rag__field" for="progress-agentic-rag-zone">
				<span><?php esc_html_e( 'Zone', 'progress-agentic-rag-connector' ); ?></span>
			...
			<label class="progress-agentic-rag__field" for="progress-agentic-rag-kbid">
				<span><?php esc_html_e( 'Knowledge Box ID', 'progress-agentic-rag-connector' ); ?></span>
			...
			<label class="progress-agentic-rag__field" for="progress-agentic-rag-account-id">
				<span><?php esc_html_e( 'Account ID', 'progress-agentic-rag-connector' ); ?></span>
			...
			<label class="progress-agentic-rag__field" for="progress-agentic-rag-token">
				<span><?php esc_html_e( 'Service token', 'progress-agentic-rag-connector' ); ?></span>
				<input type="password" id="progress-agentic-rag-token" name="<?php echo esc_attr( $token_option_name ); ?>" value="" autocomplete="new-password" placeholder="<?php esc_attr_e( 'Stored token is never displayed', 'progress-agentic-rag-connector' ); ?>" />
			</label>
		</div>
		...
		<div class="progress-agentic-rag__actions">
			<button type="submit" class="progress-agentic-rag__button progress-agentic-rag__button--primary"><?php esc_html_e( 'Save connection settings', 'progress-agentic-rag-connector' ); ?></button>
			<button type="button" class="progress-agentic-rag__button progress-agentic-rag__button--secondary" data-progress-agentic-rag-test-connection><?php esc_html_e( 'Test connection', 'progress-agentic-rag-connector' ); ?></button>
		</div>
	</form>
</section>
