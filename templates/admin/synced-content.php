...
<section class="progress-agentic-rag__panel" aria-labelledby="progress-agentic-rag-synced-content-title">
	<div class="progress-agentic-rag__panel-header">
		<div>
			<div class="progress-agentic-rag__section-label"><?php esc_html_e( 'Resource mappings', 'progress-agentic-rag' ); ?></div>
			<h2 id="progress-agentic-rag-synced-content-title"><?php esc_html_e( 'Synchronized content', 'progress-agentic-rag' ); ?></h2>
		</div>
	</div>
	<p class="progress-agentic-rag__scheduler-note" data-progress-agentic-rag-single-delete-status>
		<?php esc_html_e( 'Remove an individual resource when you want it deleted from Progress Agentic RAG and unmapped locally without clearing every synced item.', 'progress-agentic-rag' ); ?>
	</p>
	<?php if ( empty( $synced_content_rows ) ) : ?>
		<p class="progress-agentic-rag__muted"><?php esc_html_e( 'No synchronized content is currently mapped.', 'progress-agentic-rag' ); ?></p>
	<?php else : ?>
		<table class="progress-agentic-rag__sync-table">
			<thead>
				<tr>
					<th scope="col"><?php esc_html_e( 'Content', 'progress-agentic-rag' ); ?></th>
					<th scope="col"><?php esc_html_e( 'Type', 'progress-agentic-rag' ); ?></th>
					<th scope="col"><?php esc_html_e( 'Status', 'progress-agentic-rag' ); ?></th>
					<th scope="col"><?php esc_html_e( 'Resource ID', 'progress-agentic-rag' ); ?></th>
					<th scope="col"><?php esc_html_e( 'Sequence ID', 'progress-agentic-rag' ); ?></th>
					<th scope="col"><?php esc_html_e( 'Action', 'progress-agentic-rag' ); ?></th>
				</tr>
			</thead>
			<tbody>
					...
					<tr data-progress-agentic-rag-synced-row="<?php echo esc_attr( (string) $row['post_id'] ); ?>">
						<th scope="row">
							...
							<?php if ( '' !== (string) $row['url'] ) : ?>
								<a href="<?php echo esc_url( (string) $row['url'] ); ?>" target="_blank" rel="noreferrer"><?php esc_html_e( 'View', 'progress-agentic-rag' ); ?></a>
							<?php endif; ?>
						</th>
						...
						<td>
							<button type="button" class="progress-agentic-rag__button progress-agentic-rag__button--danger" data-progress-agentic-rag-delete-single-synced="<?php echo esc_attr( (string) $row['post_id'] ); ?>">
								<?php esc_html_e( 'Remove from sync', 'progress-agentic-rag' ); ?>
							</button>
						</td>
					</tr>
				<?php endforeach; ?>
