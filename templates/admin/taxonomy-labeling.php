...
<section class="progress-agentic-rag__panel" aria-labelledby="progress-agentic-rag-taxonomy-labeling-title">
	<div class="progress-agentic-rag__panel-header">
		<div>
			<div class="progress-agentic-rag__section-label"><?php esc_html_e( 'Classification rules', 'progress-agentic-rag-connector' ); ?></div>
			<h2 id="progress-agentic-rag-taxonomy-labeling-title"><?php esc_html_e( 'Taxonomy labeling', 'progress-agentic-rag-connector' ); ?></h2>
		</div>
	</div>
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
		...
		<?php if ( ! empty( $taxonomy_mapping_warnings ) ) : ?>
			<div class="progress-agentic-rag__mapping-warnings" role="status">
				<strong><?php esc_html_e( 'Mapping checks', 'progress-agentic-rag-connector' ); ?></strong>
				<ul>
		...
		<div class="progress-agentic-rag__label-reprocess" aria-live="polite">
			<div>
				<h3><?php esc_html_e( 'Label reprocessing', 'progress-agentic-rag-connector' ); ?></h3>
				<p><?php esc_html_e( 'Update labels on already synced resources with the current taxonomy mapping. Content files are not re-uploaded.', 'progress-agentic-rag-connector' ); ?></p>
				<p>
					<strong><?php esc_html_e( 'Synced resources:', 'progress-agentic-rag-connector' ); ?></strong>
				...
				<p class="progress-agentic-rag__reprocess-status">
					...
					printf(
						...
						esc_html__( 'Queue: %1$d pending, %2$d running, %3$d failed', 'progress-agentic-rag-connector' ),
			...
			<div class="progress-agentic-rag__label-actions">
				<?php if ( ! empty( $label_reprocess_status['is_active'] ) ) : ?>
					<button type="button" class="progress-agentic-rag__button progress-agentic-rag__button--secondary" data-progress-agentic-rag-label-reprocess-cancel>
						<?php esc_html_e( 'Cancel reprocessing', 'progress-agentic-rag-connector' ); ?>
					</button>
				<?php else : ?>
					<button type="button" class="progress-agentic-rag__button progress-agentic-rag__button--secondary" data-progress-agentic-rag-label-reprocess <?php disabled( ! $api_connected || ! $scheduler_available || empty( $sync_status['total_mapped'] ) || $delete_running ); ?>>
						<?php esc_html_e( 'Reprocess all labels', 'progress-agentic-rag-connector' ); ?>
					</button>
				<?php endif; ?>
			</div>
		</div>
		<div class="progress-agentic-rag__actions">
			<button type="submit" class="progress-agentic-rag__button progress-agentic-rag__button--primary"><?php esc_html_e( 'Save taxonomy labels', 'progress-agentic-rag-connector' ); ?></button>
		</div>
	</form>
</section>
