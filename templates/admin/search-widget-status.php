		...
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" data-progress-agentic-rag-widget-appearance-form>
			...
			<div class="progress-agentic-rag__widget-appearance-layout">
				...
				<label class="progress-agentic-rag__field" for="progress-agentic-rag-widget-text-color">
					<span><?php esc_html_e( 'Text color', 'progress-agentic-rag' ); ?></span>
				...
				<label class="progress-agentic-rag__field" for="progress-agentic-rag-widget-muted-color">
					<span><?php esc_html_e( 'Muted text color', 'progress-agentic-rag' ); ?></span>
				...
				<label class="progress-agentic-rag__field" for="progress-agentic-rag-widget-surface-color">
					<span><?php esc_html_e( 'Card background', 'progress-agentic-rag' ); ?></span>
				...
				<label class="progress-agentic-rag__field" for="progress-agentic-rag-widget-border-color">
					<span><?php esc_html_e( 'Border color', 'progress-agentic-rag' ); ?></span>
				...
				<label class="progress-agentic-rag__field" for="progress-agentic-rag-widget-font-family">
					<span><?php esc_html_e( 'Font family', 'progress-agentic-rag' ); ?></span>
					<select id="progress-agentic-rag-widget-font-family" name="<?php echo esc_attr( $appearance_name ); ?>[font_family]">
						<option value="roboto" <?php selected( 'roboto', $widget_appearance['font_family'] ); ?>><?php esc_html_e( 'Roboto', 'progress-agentic-rag' ); ?></option>
						<option value="inter" <?php selected( 'inter', $widget_appearance['font_family'] ); ?>><?php esc_html_e( 'Inter', 'progress-agentic-rag' ); ?></option>
						<option value="system" <?php selected( 'system', $widget_appearance['font_family'] ); ?>><?php esc_html_e( 'System font', 'progress-agentic-rag' ); ?></option>
					</select>
				</label>
				<label class="progress-agentic-rag__field" for="progress-agentic-rag-widget-font-size">
					<span><?php esc_html_e( 'Base font size', 'progress-agentic-rag' ); ?></span>
					...
					<small><?php esc_html_e( '12–24 pixels', 'progress-agentic-rag' ); ?></small>
				</label>
				<label class="progress-agentic-rag__field" for="progress-agentic-rag-widget-line-height">
					<span><?php esc_html_e( 'Line height', 'progress-agentic-rag' ); ?></span>
					...
					<small><?php esc_html_e( '1.2–2.0', 'progress-agentic-rag' ); ?></small>
				</label>
				<label class="progress-agentic-rag__field" for="progress-agentic-rag-widget-border-radius">
					<span><?php esc_html_e( 'Card corner radius', 'progress-agentic-rag' ); ?></span>
					...
					<small><?php esc_html_e( '0–24 pixels', 'progress-agentic-rag' ); ?></small>
				</label>
				<label class="progress-agentic-rag__field" for="progress-agentic-rag-widget-card-padding">
					<span><?php esc_html_e( 'Card padding', 'progress-agentic-rag' ); ?></span>
					...
					<small><?php esc_html_e( '8–48 pixels', 'progress-agentic-rag' ); ?></small>
				</label>
				<label class="progress-agentic-rag__field" for="progress-agentic-rag-widget-shadow">
					<span><?php esc_html_e( 'Card shadow', 'progress-agentic-rag' ); ?></span>
					<select id="progress-agentic-rag-widget-shadow" name="<?php echo esc_attr( $appearance_name ); ?>[shadow]">
						<option value="none" <?php selected( 'none', $widget_appearance['shadow'] ); ?>><?php esc_html_e( 'None', 'progress-agentic-rag' ); ?></option>
						<option value="subtle" <?php selected( 'subtle', $widget_appearance['shadow'] ); ?>><?php esc_html_e( 'Subtle', 'progress-agentic-rag' ); ?></option>
