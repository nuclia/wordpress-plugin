...
<section class="progress-agentic-rag__panel" aria-labelledby="progress-agentic-rag-diagnostics-title">
	<div class="progress-agentic-rag__panel-header">
		<div>
			<div class="progress-agentic-rag__section-label"><?php esc_html_e( 'Support', 'progress-agentic-rag' ); ?></div>
			<h2 id="progress-agentic-rag-diagnostics-title"><?php esc_html_e( 'Diagnostics', 'progress-agentic-rag' ); ?></h2>
		</div>
	</div>
	<p><?php esc_html_e( 'Export redacted plugin state for troubleshooting. Service tokens are never included.', 'progress-agentic-rag' ); ?></p>
	<div class="progress-agentic-rag__admin-section" aria-labelledby="progress-agentic-rag-diagnostics-failures-title">
		<div class="progress-agentic-rag__admin-section-header">
			<div>
				<div class="progress-agentic-rag__section-label"><?php esc_html_e( 'Indexation', 'progress-agentic-rag' ); ?></div>
				<h3 id="progress-agentic-rag-diagnostics-failures-title"><?php esc_html_e( 'Sync failures', 'progress-agentic-rag' ); ?></h3>
			</div>
		...
		<?php if ( empty( $failed_sync_items ) ) : ?>
			<p class="progress-agentic-rag__muted"><?php esc_html_e( 'No failed sync item details are currently recorded.', 'progress-agentic-rag' ); ?></p>
		<?php else : ?>
			...
			<?php if ( ! empty( $indexation_diagnostics['failed_items_truncated'] ) ) : ?>
				<p class="progress-agentic-rag__muted"><?php esc_html_e( 'Only the first 20 failed items are shown.', 'progress-agentic-rag' ); ?></p>
			<?php endif; ?>
		<?php endif; ?>
	</div>
	<div class="progress-agentic-rag__actions">
		<button type="button" class="progress-agentic-rag__button progress-agentic-rag__button--secondary" data-progress-agentic-rag-export-diagnostics><?php esc_html_e( 'Copy diagnostics', 'progress-agentic-rag' ); ?></button>
	</div>
